...
('POST02',  2, 'demo.community.jiyun@moment.local',   '임신 초기', '태동을 처음 느낀 날',
...
('POST04',  4, 'demo.community.haeun@moment.local',   '임신 중기', '출산 가방 체크리스트 공유해요',
 '병원 서류, 산모용품, 아기 옷, 충전기까지 챙겼습니다. 실제로 입원해 보신 분들이 꼭 필요했다고 느낀 물건이 있다면 알려주세요.', '2026-06-04 10:05:00', 9),
('POST05',  5, 'demo.community.yuna@moment.local',    '임신 중기', '쌍둥이 임신 중 수면 자세 고민',
...
('POST16', 16, 'demo.community.yuna@moment.local',    '임신 중기', '아기 용품을 두 개씩 사야 할지 고민이에요',
...
('POST18', 18, 'demo.community.nari@moment.local',    '임신 후기', '출산 전 마지막 주말을 편안하게 보냈어요',
 '멀리 나가지 않고 집 근처를 산책하고 아기 방을 정리했습니다. 배우자와 사진도 남기고 서로 수고했다고 이야기하니 마음이 한결 차분해졌어요.', '2026-06-13 13:20:00', 9),
('POST19', 19, 'demo.community.sora@moment.local',    '임신 초기', '임신 초기 피로감, 다들 어떻게 쉬고 계세요?',
 '퇴근하면 아무것도 못 할 정도로 피곤해서 저녁 약속을 줄이고 있습니다. 잠을 충분히 자도 졸린 날이 많은데 초기에는 생활 리듬을 어떻게 조절하셨는지 궁금해요.', '2026-06-13 18:10:00', 7),
('POST20', 20, 'demo.community.jiyun@moment.local',   '임신 중기', '중기로 넘어오며 입맛이 조금 돌아왔어요',
 '한동안 냄새만 맡아도 힘들었는데 이번 주부터 먹을 수 있는 음식이 늘었습니다. 급하게 양을 늘리기보다 작은 식사를 나누어 먹으며 몸 상태를 살피고 있어요.', '2026-06-13 20:40:00', 8),
('POST21', 21, 'demo.community.minseo@moment.local',  '임신 중기', '태동 시간 기록해 보시는 분 있나요?',
 '저녁 식사 후 쉬고 있을 때 태동이 자주 느껴져 간단히 시간을 메모하고 있습니다. 횟수를 비교해 불안해하기보다는 평소 아기의 움직임을 알아가는 기록으로 남겨보려고 해요.', '2026-06-14 08:25:00', 8),
('POST22', 22, 'demo.community.haeun@moment.local',   '임신 후기', '아기 방 정리는 어디까지 해두셨나요?',
 '자주 쓰는 기저귀와 옷만 손이 닿는 위치에 두고 나머지는 종류별로 정리했습니다. 출산 전에 너무 완벽하게 준비하려다 지칠 것 같아 꼭 필요한 것부터 마무리하고 있어요.', '2026-06-14 10:15:00', 6),
('POST23', 23, 'demo.community.yuna@moment.local',    '임신 중기', '쌍둥이 검진 질문을 한곳에 모으고 있어요',
 '검진 때 확인할 내용이 많아 휴대폰 메모에 성장 상태, 생활 중 불편함, 복용 중인 영양제를 정리했습니다. 진료실에서 빠뜨리지 않도록 보호자와 질문을 함께 확인하고 있어요.', '2026-06-14 12:30:00', 9),
('POST24', 24, 'demo.community.dabin@moment.local',   '임신 후기', '오후 골반 불편감 때문에 일정을 줄였어요',
 '오후가 되면 골반 주변이 무겁고 불편해서 이동이 많은 일정을 줄였습니다. 쉬어도 계속 아프거나 평소와 다른 증상이 있으면 병원에 문의하려고 합니다.', '2026-06-14 15:20:00', 7),
('POST25', 25, 'demo.community.seoyeon@moment.local', '임신 초기', '둘째를 기다리면서 첫째에게 미안한 마음이 들어요',
 '몸이 힘들어 첫째와 예전처럼 오래 놀아주지 못하는 날이면 미안해집니다. 짧더라도 집중해서 함께하는 시간을 만들고 있는데 비슷한 마음을 겪은 분들과 이야기하고 싶어요.', '2026-06-14 19:05:00', 8),
('POST26', 26, 'demo.community.nari@moment.local',    '임신 후기', '배 뭉침이 있을 때 기록부터 하고 있어요',
 '최근 배가 단단해지는 느낌이 있어 시간과 지속 정도를 메모하고 쉬어보고 있습니다. 규칙적으로 반복되거나 통증과 다른 증상이 동반되면 바로 병원에 연락할 수 있도록 연락처도 확인했어요.', '2026-06-14 22:10:00', 10),
('POST27', 27, 'demo.community.junho@moment.local',   '임신 초기', '아내가 쉬는 동안 제가 맡을 일을 정리했습니다',
 '장보기, 설거지, 냄새가 강한 음식 조리를 제가 맡고 아내가 먹을 수 있는 간단한 음식을 준비하고 있습니다. 매일 상태가 달라 계획을 고정하기보다 그날 필요한 일을 먼저 묻고 있어요.', '2026-06-15 07:45:00', 8),
('POST28', 28, 'demo.community.hyunwoo@moment.local', '임신 중기', '검진 내용을 부부가 함께 기록하는 방법',
 '검진 후 기억이 섞이지 않도록 의사 선생님의 안내와 다음 일정을 공유 메모에 적고 있습니다. 아내가 궁금해했던 내용도 같이 정리하니 다음 진료 준비가 훨씬 수월해졌어요.', '2026-06-15 09:20:00', 7),
('POST29', 29, 'demo.community.taemin@moment.local',  '임신 중기', '출산 전 생활비와 육아용품 예산을 나눠봤어요',
 '한 번에 모든 물건을 사기보다 출산 직후 필요한 것과 나중에 사도 되는 것을 구분했습니다. 정기 지출도 함께 확인하니 막연했던 부담이 조금 줄었어요.', '2026-06-15 11:35:00', 8),
('POST30', 30, 'demo.community.jisoo@moment.local',   '임신 후기', '병원 이동 경로를 실제로 확인해 봤습니다',
 '낮과 밤의 이동 시간, 주차 위치, 응급실 입구를 확인하고 차량에 필요한 가방을 실어두었습니다. 계획대로 되지 않을 수도 있지만 기본 동선을 알아두니 마음이 한결 놓입니다.', '2026-06-15 14:10:00', 9);
...
SELECT
    ...
    CASE
        WHEN (
            TIMESTAMPDIFF(
                DAY,
                COALESCE(user_info.pregnancy_start_date, pregnant_partner.pregnancy_start_date),
...
LEFT JOIN USERS AS pregnant_partner
  ON pregnant_partner.user_id = user_info.parent_user_id
 AND UPPER(pregnant_partner.role) = 'PREGNANT'
...
(43, 'POST19', 'demo.community.seoyeon@moment.local', '저도 초기에는 오후만 되면 눈을 뜨기 힘들었어요. 집안일 우선순위를 낮추고 잘 수 있을 때 쉬었습니다.', '2026-06-13 18:45:00'),
(44, 'POST19', 'demo.community.junho@moment.local',   '보호자가 약속과 집안일을 조정해 주면 쉬는 데 대한 부담이 줄어드는 것 같아요. 저희도 일정표를 단순하게 바꿨습니다.', '2026-06-13 19:20:00'),
(45, 'POST20', 'demo.community.sora@moment.local',    '입맛이 돌아왔다니 반가운 소식이네요. 저도 먹을 수 있는 음식을 하나씩 기록해 두려고 합니다.', '2026-06-13 21:05:00'),
(46, 'POST20', 'demo.community.minseo@moment.local',  '저는 갑자기 많이 먹으면 속이 불편해서 간식과 식사를 나누어 먹었어요. 몸에 맞는 속도로 늘리는 게 편했습니다.', '2026-06-13 21:40:00'),
(47, 'POST21', 'demo.community.yuna@moment.local',    '저도 시간대와 느낌을 짧게 적고 있어요. 다른 사람과 횟수를 비교하지 않고 제 평소 패턴을 보는 용도로만 사용합니다.', '2026-06-14 09:00:00'),
(48, 'POST21', 'demo.community.hyunwoo@moment.local', '부부가 함께 볼 수 있는 메모에 적어두니 검진 때 설명하기도 편했습니다. 걱정되는 변화는 바로 병원에 문의하고 있어요.', '2026-06-14 09:35:00'),
(49, 'POST21', 'demo.community.jiyun@moment.local',   '아직 움직임이 일정하지 않지만 느껴지는 순간을 기록하면 좋은 추억이 될 것 같아요.', '2026-06-14 10:10:00'),
(50, 'POST22', 'demo.community.dabin@moment.local',   '수유와 기저귀 교체에 바로 필요한 물건만 먼저 꺼내두는 방식이 현실적이었어요. 나머지는 가족에게 위치만 알려두었습니다.', '2026-06-14 10:50:00'),
(51, 'POST22', 'demo.community.nari@moment.local',    '저도 완벽하게 꾸미는 것보다 밤에 안전하게 움직일 동선을 확보하는 데 집중했어요.', '2026-06-14 11:25:00'),
(52, 'POST23', 'demo.community.minseo@moment.local',  '질문을 증상, 생활, 영양제처럼 항목별로 나누면 진료실에서 찾기 편하더라고요.', '2026-06-14 13:05:00'),
(53, 'POST23', 'demo.community.taemin@moment.local',  '보호자가 메모를 담당하고 임산부가 질문에 집중하는 방식도 좋았습니다. 안내받은 내용은 집에 와서 다시 정리했어요.', '2026-06-14 13:40:00'),
(54, 'POST23', 'demo.community.yuna@moment.local',    '작성자입니다. 다음 검진부터는 우선순위가 높은 질문에 표시해서 먼저 확인해 보려고 합니다.', '2026-06-14 14:10:00'),
(55, 'POST24', 'demo.community.haeun@moment.local',   '후기에는 무리한 일정을 줄이는 것도 중요한 준비라고 생각해요. 불편감이 지속될 때는 혼자 판단하지 않고 병원에 확인했습니다.', '2026-06-14 16:00:00'),
(56, 'POST24', 'demo.community.jisoo@moment.local',   '퇴근 시간에 맞춰 이동을 돕고 집에서는 바로 쉴 수 있게 필요한 일을 미리 해두면 좋을 것 같습니다.', '2026-06-14 16:35:00'),
(57, 'POST25', 'demo.community.haeun@moment.local',   '저도 같은 마음이 있었어요. 긴 시간보다 잠들기 전 책 한 권처럼 매일 지킬 수 있는 작은 시간을 만들었습니다.', '2026-06-14 19:40:00'),
(58, 'POST25', 'demo.community.jiyun@moment.local',   '첫째에게 엄마가 피곤한 이유를 쉬운 말로 알려주고 도와준 행동을 구체적으로 칭찬해 주는 방법도 좋다고 들었어요.', '2026-06-14 20:15:00'),
(59, 'POST25', 'demo.community.seoyeon@moment.local', '작성자입니다. 오늘은 짧게라도 첫째가 고른 놀이에 집중해 보니 저도 마음이 조금 편해졌어요.', '2026-06-14 21:00:00'),
(60, 'POST26', 'demo.community.dabin@moment.local',   '기록해 두면 병원에 문의할 때 시작 시간과 양상을 설명하기 편했습니다. 평소와 다르면 바로 확인하는 게 마음도 놓였어요.', '2026-06-14 22:35:00'),
(61, 'POST26', 'demo.community.haeun@moment.local',   '저도 병원 연락처와 이동 준비물을 눈에 보이는 곳에 두었습니다. 규칙적인 통증이나 출혈 등 안내받은 증상은 지체하지 않으려고 해요.', '2026-06-14 23:05:00'),
(62, 'POST26', 'demo.community.jisoo@moment.local',   '보호자도 기록 위치와 병원 연락 기준을 같이 알고 있어야 급할 때 바로 움직일 수 있겠네요.', '2026-06-15 06:50:00'),
(63, 'POST27', 'demo.community.sora@moment.local',    '무엇을 해줄지 계속 묻는 것보다 기본 집안일을 먼저 맡아주면 정말 편합니다. 먹을 수 있는 음식은 그날그날 달라서 선택지를 주는 것도 좋아요.', '2026-06-15 08:10:00'),
(64, 'POST27', 'demo.community.taemin@moment.local',  '저도 정답을 정해두기보다 오늘 가장 힘든 일이 무엇인지 확인하는 방식으로 바꾸고 있습니다.', '2026-06-15 08:40:00'),
(65, 'POST28', 'demo.community.jiyun@moment.local',   '제가 놓친 설명을 배우자가 적어둔 덕분에 집에서 다시 확인할 수 있었어요. 다음 검진 일정까지 같이 적어두면 편합니다.', '2026-06-15 09:55:00'),
(66, 'POST28', 'demo.community.minseo@moment.local',  '공유 메모에 질문 목록과 답변을 같은 위치에 두면 변화도 보기 쉽겠네요. 저희도 적용해 보겠습니다.', '2026-06-15 10:25:00'),
(67, 'POST29', 'demo.community.yuna@moment.local',    '쌍둥이는 수량 때문에 예산이 더 복잡했는데 필수, 대여 가능, 나중 구매로 나누니 정리가 됐어요.', '2026-06-15 12:05:00'),
(68, 'POST29', 'demo.community.junho@moment.local',   '소모품은 처음부터 많이 사기보다 아기에게 맞는지 확인한 뒤 추가 구매하는 편이 낭비를 줄이는 데 도움이 될 것 같습니다.', '2026-06-15 12:40:00'),
(69, 'POST29', 'demo.community.taemin@moment.local',  '작성자입니다. 중고나 대여가 가능한 품목도 따로 표시해서 이번 주에 다시 예산을 맞춰보겠습니다.', '2026-06-15 13:10:00'),
(70, 'POST30', 'demo.community.nari@moment.local',    '직접 이동해 보니 막연한 걱정이 줄었어요. 야간에 이용할 입구가 다른지도 확인해 두면 좋았습니다.', '2026-06-15 14:35:00'),
(71, 'POST30', 'demo.community.dabin@moment.local',   '차량 연료와 주차 방법까지 미리 확인해 두니 출산 준비 목록 하나를 끝낸 기분이 들었습니다.', '2026-06-15 15:05:00'),
(72, 'POST30', 'demo.community.jisoo@moment.local',   '작성자입니다. 병원 대표번호와 분만실 연락처도 두 사람 휴대폰에 모두 저장해 두었습니다.', '2026-06-15 15:30:00');
